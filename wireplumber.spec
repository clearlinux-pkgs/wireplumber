...
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.1/wireplumber-0.5.1.tar.gz
...
%prep
%setup -q -n wireplumber-0.5.1
cd %{_builddir}/wireplumber-0.5.1
pushd ..
cp -a wireplumber-0.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711845109
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.5.1
...
/usr/lib64/libwireplumber-0.5.so.0.5.1
