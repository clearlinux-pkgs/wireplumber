...
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.8/wireplumber-0.5.8.tar.gz
...
%prep
%setup -q -n wireplumber-0.5.8
cd %{_builddir}/wireplumber-0.5.8
pushd ..
cp -a wireplumber-0.5.8 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738972703
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.508.0
...
/usr/lib64/libwireplumber-0.5.so.0.508.0
