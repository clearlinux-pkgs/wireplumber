...
Version  : 0.5.6
Release  : 21
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.6/wireplumber-0.5.6.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.6/wireplumber-0.5.6.tar.gz
...
%prep
%setup -q -n wireplumber-0.5.6
cd %{_builddir}/wireplumber-0.5.6
pushd ..
cp -a wireplumber-0.5.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725631411
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.506.0
...
/usr/lib64/libwireplumber-0.5.so.0.506.0
