...
Version  : 0.5.7
Release  : 22
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.7/wireplumber-0.5.7.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.7/wireplumber-0.5.7.tar.gz
...
%prep
%setup -q -n wireplumber-0.5.7
cd %{_builddir}/wireplumber-0.5.7
pushd ..
cp -a wireplumber-0.5.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733162171
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.507.0
...
/usr/lib64/libwireplumber-0.5.so.0.507.0
