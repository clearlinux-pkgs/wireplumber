...
Version  : 0.4.12
Release  : 3
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.12/wireplumber-0.4.12.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.12/wireplumber-0.4.12.tar.gz
...
%prep
%setup -q -n wireplumber-0.4.12
cd %{_builddir}/wireplumber-0.4.12
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670025944
...
/usr/lib64/libwireplumber-0.4.so.0.4.12
