...
Version  : 0.5.2
Release  : 17
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.2/wireplumber-0.5.2.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.2/wireplumber-0.5.2.tar.gz
...
%prep
%setup -q -n wireplumber-0.5.2
cd %{_builddir}/wireplumber-0.5.2
pushd ..
cp -a wireplumber-0.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713812608
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.502.0
...
/usr/lib64/libwireplumber-0.5.so.0.502.0
