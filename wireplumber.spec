...
Version  : 0.4.81
Release  : 12
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.81/wireplumber-0.4.81.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.81/wireplumber-0.4.81.tar.gz
...
%prep
%setup -q -n wireplumber-0.4.81
cd %{_builddir}/wireplumber-0.4.81
pushd ..
cp -a wireplumber-0.4.81 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1704404064
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.4.81
...
/usr/lib64/libwireplumber-0.5.so.0.4.81
