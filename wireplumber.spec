...
Version  : 0.4.90
Release  : 14
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.90/wireplumber-0.4.90.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.90/wireplumber-0.4.90.tar.gz
...
%prep
%setup -q -n wireplumber-0.4.90
cd %{_builddir}/wireplumber-0.4.90
pushd ..
cp -a wireplumber-0.4.90 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709581223
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.4.90
...
/usr/lib64/libwireplumber-0.5.so.0.4.90
