...
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.4.13/wireplumber-0.4.13.tar.gz
...
%prep
%setup -q -n wireplumber-0.4.13
cd %{_builddir}/wireplumber-0.4.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670967007
...
/usr/lib64/libwireplumber-0.4.so.0.4.13
