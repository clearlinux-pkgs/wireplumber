...
Version  : 0.5.0
Release  : 15
URL      : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.0/wireplumber-0.5.0.tar.gz
Source0  : https://gitlab.freedesktop.org/pipewire/wireplumber/-/archive/0.5.0/wireplumber-0.5.0.tar.gz
...
%prep
%setup -q -n wireplumber-0.5.0
cd %{_builddir}/wireplumber-0.5.0
pushd ..
cp -a wireplumber-0.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710784546
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libwireplumber-0.5.so.0.5.0
...
/usr/lib64/libwireplumber-0.5.so.0.5.0
